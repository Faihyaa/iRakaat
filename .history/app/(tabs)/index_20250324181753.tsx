  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.counterContainer}>
        <Text style={styles.counterNumb}>{rakaat}</Text>
        <Text style={styles.counterLabel}>Rakaat</Text>
        <Text style={styles.counterNumb}>{sujud}</Text>
        <Text style={styles.counterLabel}>Sujud</Text>
      </View>
